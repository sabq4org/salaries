...
### 6. **تصفية الإجازات**
- حساب استحقاق إجازة الموظف بدقة
- إضافة الأرصدة السابقة
- خصم الإجازة الحالية
- احتساب التذاكر والتأشيرات
- حساب الخصومات
...
- ألوان تحذيرية حسب القرب من الموعد
- ربط التذكير بموظف معين (اختياري)
...
- [x] تصدير مسير الرواتب إلى Excel
- [ ] تصدير مسير الرواتب إلى PDF (قيد التطوير)
- [x] إضافة قسم تصفية الإجازات
- [x] إضافة قسم التذكيرات
